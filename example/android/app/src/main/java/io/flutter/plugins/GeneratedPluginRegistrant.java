...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.example.pixel_to_pdf.PixelToPdfPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin pixel_to_pdf, com.example.pixel_to_pdf.PixelToPdfPlugin", e);
    }
  }
}
